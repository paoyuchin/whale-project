...
<body>
    ...
    <div class="achieve-middle-section">
        <div class="middle-section1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98.21 55.91" id="svg">
                <defs>
                    <style>
                        .cls-1 {
                            fill: white;
                ...
                <style>
                    .mYksWWcr_0 {
                        stroke-dasharray: 1096 1098;
                        stroke-dashoffset: 1097;
                    }

                    .start .mYksWWcr_0 {
                        animation: mYksWWcr_draw 9000ms ease-in-out 0ms forwards;
                    }

                    @keyframes mYksWWcr_draw {
                        100% {
                            stroke-dashoffset: 0;
                        }
                    }

                    @keyframes mYksWWcr_fade {
                        0% {
                            stroke-opacity: 1;
                        }
                        96.07843137254902% {
        ...
        <h2 class="middle-section2">守護鯨豚，擁抱海洋</h2>
        <h5 class="middle-section3">為社團法人中華鯨豚協會（以下簡稱本會）發起，為有效推動臺灣海洋永續文化及有效提升鯨豚擱淺救援存活率，聯合各地保育團體、伙伴與志工共同推廣正面的臺灣海洋文化、鯨豚生態，舉辦鯨豚擱淺救援志工訓練、更新鯨豚救援設備，志工解說員訓練、海洋環境教育等課程。
            募款許可字號：. 衛部救字
        </h5>
    </div>
    <!-- javescript -->
    ...
    <div id="grid" class="grid clearfix">
        <div class="achievement-btn-fahter clearfix">
        ...
        <script>
            ...
            $('#b2').click(function () {
                $('#B').css('display', 'block');
                var div = document.querySelector('.btn2-inside');
                var size = window.getComputedStyle(div, '::after').getPropertyValue('top');
                // console.log(size);
                $('#A').css('display', 'none');
                size.css.top = "200px"
